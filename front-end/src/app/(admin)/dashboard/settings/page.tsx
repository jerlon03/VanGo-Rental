...
const SettingsPage = () => {
    ...
    const handleSinglePaymentUpdate = async (index: number) => {
        ...
        try {
            ...
            toast.update(toastId, {
                render: error instanceof Error ? error.message : "Failed to update payment",
                type: "error",
                isLoading: false,
                autoClose: 3000
            });
    ...
    const handleSaveChanges = async () => {
        ...
        try {
            const result = await SweetAlert.showConfirm('You want to save these changes?')
    ...
    return (
        <div className='w-full'>
            ...
            <div className='w-full pb-5'>
                <AdminHeader>
                    <h1 className='text-[14px] flex items-end text-blackColor/70 tracking-[2px]'><Link href="/dashboard">Dashboard</Link>/ Settings</h1>
                </AdminHeader>
            </div>
            <div className='w-full px-[2%]'>
                <div className='flex gap-2 mb-4'>
                    <span
                        className={`cursor-pointer px-4 py-1 ${activeTab === 'profile'
                    ...
                    <span
                        className={`cursor-pointer px-4 py-1 ${activeTab === 'payment'
                            ? 'border-b-2 border-primaryColor text-primaryColor font-medium'
                            : 'text-gray-600 hover:text-blue-500'
                            }`}
                ...
                {activeTab === 'profile' && (
                    <div className='w-full flex justify-between'>
                        <div className='bg-white p-4 rounded-lg shadow-sm w-[70%]'>
                            <h2 className='text-[20px] font-semibold mb-6'>Profile Settings</h2>
                            <div className='w-full'>
                        ...
                        <div className='w-[30%]'>
                            <div className='bg-white border rounded-lg px-6 py-4 shadow-sm'>
                                <h3 className='text-[18px] font-semibold mb-4 text-gray-800'>Account Details</h3>
                                ...
                                <div className='space-y-4'>
                                    ...
                                    <div className='space-y-2 ml-7'>
                                        {/* Permission Items */}
                                        {['Dashboard Access', 'User Management', 'Content Management', 'Booking Management', 'Settings Management'].map((permission) => (
                            ...
                            {paymentForms.map((form, index) => (
                                <div key={index} className="mb-2 p-4 border rounded-lg">
                                    ...
                                    <div className='w-full flex justify-between gap-4'>
                                        <div className="w-[40%]">
                                            <label htmlFor={`paymentName-${index}`} className="text-sm font-medium text-gray-700">
                                                Payment Method Name
                                            </label>
                                            <InputField
                                                type="text"
                                        ...
                                        <div className="w-[37%]">
                                            <label htmlFor={`paymentImage-${index}`} className="text-sm font-medium text-gray-700">
                                            ...
                                            <div className="relative">
                                                ...
                                                <div className="mt-1 flex items-center">
                                                    ...
                                                    <span className="flex-1 px-4 py-2 border border-l-0 border-gray-300 rounded-r-[5px] bg-white text-gray-500 truncate">
                                                        {form.qrImage?.name || payments[index]?.payment_name || 'No file chosen'}
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-[22%]">
                                            ...
                                            <div className="border border-gray-200 rounded-lg mt-2">
                                                {(form.previewUrl || payments[index]?.payment_image) && (
                                                    <div className="relative">
                                                        <Image
                                                            src={form.previewUrl || payments[index]?.payment_image}
                                                            alt="QR Code Preview"
                                                            width={200}
                                                            height={200}
                                            ...
                                            {((form.paymentName !== payments[index]?.payment_name && form.paymentName !== '') &&
                                                form.qrImage !== null) && (
                                                    <Button
